...
class SegmentationLayer(Layer, _AnnotationLayerOptions):
    ...
    set_segments_black = setSegmentsBlack = wrapped_property('setSegmentsBlack', optional(bool, True))
    set_segments_grayscale = setSegmentsGrayScale = wrapped_property('setSegmentsGrayScale', optional(bool, True))
