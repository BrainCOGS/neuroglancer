...
export class AraAtlas {
    ...
    ara_id: Map<number, string> = new Map([
        ...
        [8, "8: grey: Basic cell groups and regions"],
        ...
        [10672, "10672: SIMgr: Simple lobule, granular layer"],
        [10673, "10673: SIMpu: Simple lobule, Purkinje layer"],
        [10674, "10674: SIMmo: Simple lobule, molecular layer"],
        [10675, "10675: ANcr1gr: Crus 1, granular layer"],
        [10676, "10676: ANcr1pu: Crus 1, Purkinje layer"],
        [10677, "10677: ANcr1mo: Crus 1, molecular layer"],
        [10678, "10678: ANcr2gr: Crus 2, granular layer"],
        [10679, "10679: ANcr2pu: Crus 2, Purkinje layer"],
        [10680, "10680: ANcr2mo: Crus 2, molecular layer"],
        [10681, "10681: PRMgr: Paramedian lobule, granular layer"],
        [10682, "10682: PRMpu: Paramedian lobule, Purkinje layer"],
        [10683, "10683: PRMmo: Paramedian lobule, molecular layer"],
        [10684, "10684: COPYgr: Copula pyramidis, granular layer"],
        [10685, "10685: COPYpu: Copula pyramidis, Purkinje layer"],
        [10686, "10686: COPYmo: Copula pyramidis, molecular layer"],
        [10687, "10687: PFLgr: Paraflocculus, granular layer"],
        [10688, "10688: PFLpu: Paraflocculus, Purkinje layer"],
        [10689, "10689: PFLmo: Paraflocculus, molecular layer"],
        [10690, "10690: FLgr: Flocculus, granular layer"],
        [10691, "10691: FLpu: Flocculus, Purkinje layer"],
        [10692, "10692: FLmo: Flocculus, molecular layer"],
        [10693, "10693: PAR1: Parasubiculum, layer 1"],
        [10694, "10694: PAR2: Parasubiculum, layer 2"],
        [10695, "10695: PAR3: Parasubiculum, layer 3"],
        [10696, "10696: POST1: Postsubiculum, layer 1"],
        [10697, "10697: POST2: Postsubiculum, layer 2"],
        [10698, "10698: POST3: Postsubiculum, layer 3"],
        [10699, "10699: PRE1: Presubiculum, layer 1"],
        [10700, "10700: PRE2: Presubiculum, layer 2"],
        [10701, "10701: PRE3: Presubiculum, layer 3"],
        [10702, "10702: DG-sgz: Dentate gyrus, subgranular zone"],
        [10703, "10703: DG-mo: Dentate gyrus, molecular layer"],
        [10704, "10704: DG-po: Dentate gyrus, polymorph layer"],
        [10705, "10705: LINGgr: Lingula (I), granular layer"],
        [10706, "10706: LINGpu: Lingula (I), Purkinje layer"],
        [10707, "10707: LINGmo: Lingula (I), molecular layer"],
        [10708, "10708: CENT2gr: Lobule II, granular layer"],
        [10709, "10709: CENT2pu: Lobule II, Purkinje layer"],
        [10710, "10710: CENT2mo: Lobule II, molecular layer"],
        [10711, "10711: CENT3gr: Lobule III, granular layer"],
        [10712, "10712: CENT3pu: Lobule III, Purkinje layer"],
        [10713, "10713: CENT3mo: Lobule III, molecular layer"],
        [10714, "10714: CUL4gr: Lobule IV, granular layer"],
        [10715, "10715: CUL4pu: Lobule IV, Purkinje layer"],
        [10716, "10716: CUL4mo: Lobule IV, molecular layer"],
        [10717, "10717: CUL5gr: Lobule V, granular layer"],
        [10718, "10718: CUL5pu: Lobule V, Purkinje layer"],
        [10719, "10719: CUL5mo: Lobule V, molecular layer"],
        [10720, "10720: CUL4, 5gr: Lobules IV-V, granular layer"],
        [10721, "10721: CUL4, 5pu: Lobules IV-V, Purkinje layer"],
        [10722, "10722: CUL4, 5mo: Lobules IV-V, molecular layer"],
        [10723, "10723: DECgr: Declive (VI), granular layer"],
        [10724, "10724: DECpu: Declive (VI), Purkinje layer"],
        [10725, "10725: DECmo: Declive (VI), molecular layer"],
        [10726, "10726: FOTUgr: Folium-tuber vermis (VII), granular layer"],
        [10727, "10727: FOTUpu: Folium-tuber vermis (VII), Purkinje layer"],
        [10728, "10728: FOTUmo: Folium-tuber vermis (VII), molecular layer"],
        [10729, "10729: PYRgr: Pyramus (VIII), granular layer"],
        [10730, "10730: PYRpu: Pyramus (VIII), Purkinje layer"],
        [10731, "10731: PYRmo: Pyramus (VIII), molecular layer"],
        [10732, "10732: UVUgr: Uvula (IX), granular layer"],
        [10733, "10733: UVUpu: Uvula (IX), Purkinje layer"],
        [10734, "10734: UVUmo: Uvula (IX), molecular layer"],
        [10735, "10735: NODgr: Nodulus (X), granular layer"],
        [10736, "10736: NODpu: Nodulus (X), Purkinje layer"],
        [10737, "10737: NODmo: Nodulus (X), molecular layer"],
        [12993, "12993: SS1: Somatosensory areas, layer 1"],
        [12994, "12994: SS2/3: Somatosensory areas, layer 2/3"],
        [12995, "12995: SS4: Somatosensory areas, layer 4"],
        [12996, "12996: SS5: Somatosensory areas, layer 5"],
        [12997, "12997: SS6a: Somatosensory areas, layer 6a"],
        [12998, "12998: SS6b: Somatosensory areas, layer 6b"],
        [182305689, "182305689: SSp-un: Primary somatosensory area, unassigned"],
        [182305693, "182305693: SSp-un1: Primary somatosensory area, unassigned, layer 1"],
        [182305697, "182305697: SSp-un2/3: Primary somatosensory area, unassigned, layer 2/3"],
        [182305701, "182305701: SSp-un4: Primary somatosensory area, unassigned, layer 4"],
        [182305705, "182305705: SSp-un5: Primary somatosensory area, unassigned, layer 5"],
        [182305709, "182305709: SSp-un6a: Primary somatosensory area, unassigned, layer 6a"],
        [182305713, "182305713: SSp-un6b: Primary somatosensory area, unassigned, layer 6b"],
        [304325711, "304325711: retina: retina"],
        [312782546, "312782546: VISa: Anterior area"],
        [312782550, "312782550: VISa1: Anterior area, layer 1"],
        [312782554, "312782554: VISa2/3: Anterior area, layer 2/3"],
        [312782558, "312782558: VISa4: Anterior area, layer 4"],
        [312782562, "312782562: VISa5: Anterior area, layer 5"],
        [312782566, "312782566: VISa6a: Anterior area, layer 6a"],
        [312782570, "312782570: VISa6b: Anterior area, layer 6b"],
        [312782574, "312782574: VISli: Laterointermediate area"],
        [312782578, "312782578: VISli1: Laterointermediate area, layer 1"],
        [312782582, "312782582: VISli2/3: Laterointermediate area, layer 2/3"],
        [312782586, "312782586: VISli4: Laterointermediate area, layer 4"],
        [312782590, "312782590: VISli5: Laterointermediate area, layer 5"],
        [312782594, "312782594: VISli6a: Laterointermediate area, layer 6a"],
        [312782598, "312782598: VISli6b: Laterointermediate area, layer 6b"],
        [312782604, "312782604: VISrl1: Rostrolateral area, layer 1"],
        [312782608, "312782608: VISrl2/3: Rostrolateral area, layer 2/3"],
        [312782612, "312782612: VISrl4: Rostrolateral area, layer 4"],
        [312782616, "312782616: VISrl5: Rostrolateral area, layer 5"],
        [312782620, "312782620: VISrl6a: Rostrolateral area, layer 6a"],
        [312782624, "312782624: VISrl6b: Rostrolateral area, layer 6b"],
        [312782628, "312782628: VISpor: Postrhinal area"],
        [312782632, "312782632: VISpor1: Postrhinal area, layer 1"],
        [312782636, "312782636: VISpor2/3: Postrhinal area, layer 2/3"],
        [312782640, "312782640: VISpor4: Postrhinal area, layer 4"],
        [312782644, "312782644: VISpor5: Postrhinal area, layer 5"],
        [312782648, "312782648: VISpor6a: Postrhinal area, layer 6a"],
        [312782652, "312782652: VISpor6b: Postrhinal area, layer 6b"],
        [480149202, "480149202: VISrll: Rostrolateral lateral visual area"],
        [480149206, "480149206: VISrll1: Rostrolateral lateral visual area, layer 1"],
        [480149210, "480149210: VISrll2/3: Rostrolateral lateral visual area, layer 2/3"],
        [480149214, "480149214: VISrll4: Rostrolateral lateral visual area, layer 4"],
        [480149218, "480149218: VISrll5: Rostrolateral lateral visual area,layer 5"],
        [480149222, "480149222: VISrll6a: Rostrolateral lateral visual area, layer 6a"],
        [480149226, "480149226: VISrll6b: Rostrolateral lateral visual area, layer 6b"],
        [480149230, "480149230: VISlla: Laterolateral anterior visual area"],
        [480149234, "480149234: VISlla1: Laterolateral anterior visual area, layer 1"],
        [480149238, "480149238: VISlla2/3: Laterolateral anterior visual area, layer 2/3"],
        [480149242, "480149242: VISlla4: Laterolateral anterior visual area, layer 4"],
        [480149246, "480149246: VISlla5: Laterolateral anterior visual area,layer 5"],
        [480149250, "480149250: VISlla6a: Laterolateral anterior visual area, layer 6a"],
        [480149254, "480149254: VISlla6b: Laterolateral anterior visual area, layer 6b"],
        [480149258, "480149258: VISmma: Mediomedial anterior visual area"],
        [480149262, "480149262: VISmma1: Mediomedial anterior visual area, layer 1"],
        [480149266, "480149266: VISmma2/3: Mediomedial anterior visual area, layer 2/3"],
        [480149270, "480149270: VISmma4: Mediomedial anterior visual area, layer 4"],
        [480149274, "480149274: VISmma5: Mediomedial anterior visual area,layer 5"],
        [480149278, "480149278: VISmma6a: Mediomedial anterior visual area, layer 6a"],
        [480149282, "480149282: VISmma6b: Mediomedial anterior visual area, layer 6b"],
        [480149286, "480149286: VISmmp: Mediomedial posterior visual area"],
        [480149290, "480149290: VISmmp1: Mediomedial posterior visual area, layer 1"],
        [480149294, "480149294: VISmmp2/3: Mediomedial posterior visual area, layer 2/3"],
        [480149298, "480149298: VISmmp4: Mediomedial posterior visual area, layer 4"],
        [480149302, "480149302: VISmmp5: Mediomedial posterior visual area,layer 5"],
        [480149306, "480149306: VISmmp6a: Mediomedial posterior visual area, layer 6a"],
        [480149310, "480149310: VISmmp6b: Mediomedial posterior visual area, layer 6b"],
        [480149314, "480149314: VISm: Medial visual area"],
        [480149318, "480149318: VISm1: Medial visual area, layer 1"],
        [480149322, "480149322: VISm2/3: Medial visual area, layer 2/3"],
        [480149326, "480149326: VISm4: Medial visual area, layer 4"],
        [480149330, "480149330: VISm5: Medial visual area,layer 5"],
        [480149334, "480149334: VISm6a: Medial visual area, layer 6a"],
        [480149338, "480149338: VISm6b: Medial visual area, layer 6b"],
        [484682470, "484682470: ProS: Prosubiculum"],
        [484682475, "484682475: ProSd: Prosubiculum, dorsal part"],
        [484682479, "484682479: ProSd-m: Prosubiculum, dorsal part, molecular layer"],
        [484682483, "484682483: ProSd-sp: Prosubiculum, dorsal part, pyramidal layer"],
        [484682487, "484682487: ProSd-sr: Prosubiculum, dorsal part, stratum radiatum"],
        [484682492, "484682492: ProSv: Prosubiculum, ventral part"],
        [484682496, "484682496: ProSv-m: Prosubiculum, ventral part, molecular layer"],
        [484682500, "484682500: ProSv-sp: Prosubiculum, ventral part, pyramidal layer"],
        [484682504, "484682504: Prosv-sr: Prosubiculum, ventral part, stratum radiatum"],
        [484682508, "484682508: APr: Area prostriata"],
        [484682512, "484682512: scwm: supra-callosal cerebral white matter"],
        [484682516, "484682516: ccb: corpus callosum, body"],
        [484682520, "484682520: or: optic radiation"],
        [484682524, "484682524: ar: auditory radiation"],
        ...
        [496345668, "496345668: LGd-co: Dorsal part of the lateral geniculate complex, core"],
        [496345672, "496345672: LGd-ip: Dorsal part of the lateral geniculate complex, ipsilateral zone"],
        [526157192, "526157192: FRP5: Frontal pole, layer 5"],
        [526157196, "526157196: FRP6a: Frontal pole, layer 6a"],
        [526322264, "526322264: FRP6b: Frontal pole, layer 6b"],
        [527696977, "527696977: ORBm6b: Orbital area, medial part, layer 6b"],
        [549009199, "549009199: LSS: Lateral strip of striatum"],
        [549009203, "549009203: RPF: Retroparafascicular nucleus"],
        [549009207, "549009207: InCo: Intercollicular nucleus"],
        [549009211, "549009211: MA3: Medial accesory oculomotor nucleus"],
        [549009215, "549009215: P5: Peritrigeminal zone"],
        [549009219, "549009219: Acs5: Accessory trigeminal nucleus"],
        [549009223, "549009223: PC5: Parvicellular motor 5 nucleus"],
        [549009227, "549009227: I5: Intertrigeminal nucleus"],
        [560581551, "560581551: Eth: Ethmoid nucleus of the thalamus"],
        [560581555, "560581555: REth: Retroethmoid nucleus"],
        [560581559, "560581559: Xi: Xiphoid thalamic nucleus"],
        [560581563, "560581563: PIL: Posterior intralaminar thalamic nucleus"],
        [563807435, "563807435: PoT: Posterior triangular thalamic nucleus"],
        [563807439, "563807439: IntG: Intermediate geniculate nucleus"],
        [576073699, "576073699: VMPO: Ventromedial preoptic nucleus"],
        [576073704, "576073704: PeF: Perifornical nucleus"],
        [589508447, "589508447: HATA: Hippocampo-amygdalar transition area"],
        [589508451, "589508451: Pa5: Paratrigeminal nucleus"],
        [589508455, "589508455: VeCB: Vestibulocerebellar nucleus"],
        [599626923, "599626923: SCO: Subcommissural organ"],
        [599626927, "599626927: PDTg: Posterodorsal tegmental nucleus"],
        [606826647, "606826647: MMl: Medial mammillary nucleus, lateral part"],
        [606826651, "606826651: MMm: Medial mammillary nucleus, medial part"],
        [606826655, "606826655: MMp: Medial mammillary nucleus, posterior part"],
        [606826659, "606826659: MMd: Medial mammillary nucleus, dorsal part"],
        [606826663, "606826663: Pa4: Paratrochlear nucleus"],
        [607344830, "607344830: PN: Paranigral nucleus"],
        [607344834, "607344834: IPR: Interpeduncular nucleus, rostral"],
        [607344838, "607344838: IPC: Interpeduncular nucleus, caudal"],
        [607344842, "607344842: IPA: Interpeduncular nucleus, apical"],
        [607344846, "607344846: IPL: Interpeduncular nucleus, lateral"],
        [607344850, "607344850: IPI: Interpeduncular nucleus, intermediate"],
        [607344854, "607344854: IPDM: Interpeduncular nucleus, dorsomedial"],
        [607344858, "607344858: IPDL: Interpeduncular nucleus, dorsolateral"],
        [607344862, "607344862: IPRL: Interpeduncular nucleus, rostrolateral"],
        [614454277, "614454277: Su3: Supraoculomotor periaqueductal gray"]
    ]);
